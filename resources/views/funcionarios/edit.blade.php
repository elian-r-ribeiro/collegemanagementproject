            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800">
                    ...
                    <form action="{{ route('funcionarios.update', $funcionario->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="dataDeContratacao" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Data de contratação:</label>
                            <input type="text" name="dataDeContratacao" id="dataDeContratacao" class="form-input mt-1 block w-full" value="{{ $funcionario->dataDeContratacao }}" required>
                        </div>
